...
class SRPAuthenticationHelper {

    private static Logger logger = LogManager.getLogger(SRPAuthenticationHelper.class);
    ...
    SRPAuthenticationHelper(String userPoolID, String clientid, String... secretKey) {
        do {
        ...
        this.region = region;
        this.secretKey = secretKey.length>0 ? secretKey[0] : "";
     ...
     */
    String PerformSRPAuthentication(AWSCognitoIdentityProvider client, String username, String password) {
        ...
        try {
            ...
            if (ChallengeNameType.PASSWORD_VERIFIER.toString().equals(initiateAuthResult.getChallengeName())) {
                ...
                RespondToAuthChallengeResult result = client.respondToAuthChallenge(challengeRequest);
