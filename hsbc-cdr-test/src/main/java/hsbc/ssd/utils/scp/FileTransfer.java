...
public class FileTransfer {
    static Logger log = LogManager.getLogger(FileTransfer.class);
    ...
    public static void main(String[] arg) throws IOException, JSchException {
        ...
        copyLocalToRemote(session, local, remoteB);
    }
    ...
    public static void copyLocalToRemote(Session session, String filePath, String to) throws JSchException, IOException {
